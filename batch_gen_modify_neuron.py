...
def run_modifier(inputSWC_file, outputSWC_file,r_scale, x_scale, y_scale, z_scale, prune_level ):
...
if __name__ == "__main__":
    ...
    default_result_dir = '/local1/xiaoxiaol/work/data/lims2/modified_neurons'
    ...
    for  r_scale in np.arange(0.5,1.6,0.1):
	    ...
	    with open(input_para_file,'r') as f:
		 for line in f:
		      ...
		      run_modifier(inputSWC_file, outputSWC_file, r_scale, x_scale,y_scale, z_scale, prune_level ) 
