...
if (platform.system() == "Linux"):
    ...
    V3D="/Users/xiaoxiaol/work/v3d/v3d_external/bin/vaa3d64.app/Contents/MacOS/vaa3d64"""""



V3D =  "/data/mat/xiaoxiaol/work/bin/bin_vaa3d_for_clusters/start_vaa3d.sh"
"""if (platform.system() == "Linux"):
    WORK_PATH = "/local1/home/coriannaj/"

p = WORK_PATH + '/src/profiling_analysis'
sys.path.append(p)
"""
    ...
    for dirName, subdirList, fileList in os.walk(data_DIR, topdown=False):
        if dirName != data_DIR:
            if not os.path.basename(dirName).isdigit():
                #if subfolder do nothing
                #print "HERe"
                continue

            #print "In folder: " + dirName
            ...
            profile_path = os.path.join(subfolder_path, 'profile_05ratio.csv')
            ...
            #print "After checking files, swc = " + str(swc) + " img = " + str(img)
            ...
            print overall_profile
            overall_profile.to_csv('/local1/home/coriannaj/Desktop/0401_gold163_all_soma_sort/sorted_img_profiling.csv')
    return
